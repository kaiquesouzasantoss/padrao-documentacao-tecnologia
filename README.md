...
- [Modelos de Documentação](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao)
    - [Back-End](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/backend)
    - [Front-End](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/frontend)
    - [Mobile](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/mobile)
    - [RPA](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/rpa)
    - [Arduino](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/arduino)
    - [Testes](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/testes_automatizados)
    - [DevOps](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/devops)
    - [Microserviços](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/microservicos)
    - [Arquitetura de Solução](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/arquitetura_solucao)
    - [API GraphQL](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/modelos-documentacao/api_graphql)
- [Guias Utilitários](https://github.com/kaiquesouzasantoss/padrao-documentacao-tecnologia/tree/main/utilitarios)
